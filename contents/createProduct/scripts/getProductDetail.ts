...
export const getProductDetail = async (productId: string) => {
  const res = await fetch("https://online.ctrip.com/restapi/soa2/15638/getProductBaseInfo?_fxpcqlniredt=09031072216594047056&_fxpcqlniredt=09031072216594047056", {
    "headers": {
      "accept": "*/*",
      "accept-language": "en",
