...
export const updateResourceActive = async (productId: string | number) => {
  ...
  const res = await fetch(
    "https://online.ctrip.com/restapi/soa2/15638/updateResourceActive.json?_fxpcqlniredt=09031015310214817373&_fxpcqlniredt=09031015310214817373",
    {
      headers: {
        accept: "*/*",
  ...
  if (resJson.ResponseStatus.Ack === "Failure") {
    ...
    throw new Error(resJson.ResponseStatus.Errors[0].Message);
  }
  return resJson;
};
